...
frappe.ui.form.on("Lead", {
    validate(frm) {
        ...
        else if (cur_frm.doc.province && cur_frm.doc.citys && cur_frm.doc.custom_address_line){
            cur_frm.set_value("full_address",
            cur_frm.doc.custom_address_line+', '
            +cur_frm.doc.citys+', '
            +cur_frm.doc.province
        ...
        else if (cur_frm.doc.province && cur_frm.doc.citys){
            cur_frm.set_value("full_address",
            cur_frm.doc.citys+', '+cur_frm.doc.province);
            cur_frm.refresh_field('full_address');
        }
        else{
            cur_frm.set_value("full_address",cur_frm.doc.province);
            cur_frm.refresh_field('full_address');
    ...
    province(frm) {
        ...
        else if (cur_frm.doc.citys && cur_frm.doc.custom_address_line){
            cur_frm.set_value("full_address",
            cur_frm.doc.custom_address_line+', '
            +cur_frm.doc.citys+', '
            +cur_frm.doc.province
    ...
    citys(frm) {
        if(cur_frm.doc.province && cur_frm.doc.custom_address_line){
            cur_frm.set_value("full_address",
            cur_frm.doc.custom_address_line+', '
            +cur_frm.doc.citys+', '
            +cur_frm.doc.province
    ...
    custom_address_line(frm) {
        if(cur_frm.doc.province && cur_frm.doc.citys){
            cur_frm.set_value("full_address",
            cur_frm.doc.custom_address_line+', '
            +cur_frm.doc.citys+', '
            +cur_frm.doc.province
        ...
        else(cur_frm.doc.province && cur_frm.doc.citys && cur_frm.doc.custom_address_line){
            cur_frm.set_value("full_address",
            cur_frm.doc.custom_address_line+', '
            +cur_frm.doc.areas+', '
            +cur_frm.doc.citys+', '
